...
# @File  : data_helper.py
# @Author: sl
# @Date  : 2021/10/23 - 下午3:40

import json
import random
import pandas as pd

from util.constant import DATA_NLP_CLASS_CMID, DATA_NLP_CLASS_DISEASES
...
def gen_sample_base_template():
    ...
    disease_list = json.load(
        open(DATA_NLP_CLASS_DISEASES, 'r', encoding='utf8'))
