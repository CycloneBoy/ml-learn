...
if __name__ == '__main__':
    ...
    #  开始检测
    # video_file = "/home/sl/视频/生活/VID_20210103_081552.mp4"
    video_file = "/home/sl/视频/生活/VID_20210103_080924.mp4"
    ...
    writer = cv2.VideoWriter("/home/sl/视频/生活//output.mp4", fourcc, fps, (width, height), 1)
    ...
    while cap.isOpened():
        ...
        try:
            ...
            line_img = hough_func(roi_image, rho=1, theta=np.pi / 180, threshold=15, min_line_lenght=40,
                                  max_line_gap=20)
